...
<section class="content">
	...
	<form class="form-horizontal" style="background: white" method="post" id="form_accuracy_order" action="{{url('admin/postaccuracyorder')}}">
		{{csrf_field()}}
		<div class="tab-content">
			<div id="home" class="tab-pane fade in active">
				@include('business.orders.accuracy.incomeinfo')

			</div>
			<div id="menu1" class="tab-pane fade ">
				@include('business.orders.accuracy.inforuser')
			</div>
