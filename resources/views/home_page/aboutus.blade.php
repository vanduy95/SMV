		...
		<div class=" row col-lg-12 col-md-12 col-xs-12">
			<div class="interest-client col-lg-3 col-md-3 col-xs-3">
				<div class="div-items col-lg-12 col-md-12 col-xs-12">
					...
					<div class="div-item col-lg-6 col-md-6 col-xs-6"></div>
					<div class="div-item col-lg-6 col-md-6 col-xs-6">
						<div class="div-bg-gradient col-lg-12"></div>
					</div>
					<div class="div-item col-lg-6 col-md-6 col-xs-6"></div>
					<div class="clear"></div>
				</div>
			...
			<div class="col-lg-offfset-1 col-md-offset-1 col-lg-7 col-md-7 col-xs-12">
				...
				<p class="interest-content">
					<i class="fa fa-play" aria-hidden="true"></i>Xây dựng nền tảng công nghệ hoàn toàn trực tuyến giúp tiết kiệm tối đa chi phí hoạt động để giảm thiểu chi phí cho khách hàng.
				</p>
				<p class="interest-content">
					<i class="fa fa-play" aria-hidden="true"></i>Hợp tác với các đối tác bán lẻ lớn và uy tín để xây dựng chương trình ưu đãi trọng tâm cho khách hàng.
				</p>
			</div>
		</div>
		<div class="clear"></div>
			...
			<div class="col-lg-12 col-md-12 col-xs-12 div-center">
				<div class="contact-info col-lg-10 col-md-10 col-xs-10">
					...
					<p>
						...
						<span class="address">302, Tầng 3 tòa nhà Fafilm Việt Nam</span>
						<span>19 Nguyễn Trãi, Thanh Xuân, Hà Nội.</span>
					</p>
					<p><i class="fa fa-phone" aria-hidden="true"></i><span>024.66552428</span></p>
					<p><span>Hotline:</span><span>0904.633568</p>
				</div>
			</div>
		</div>
	</section>
