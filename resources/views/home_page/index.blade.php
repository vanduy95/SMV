...
<section class="container-fluid" style="padding: 0">
			...
			<div class="bg-content col-xs-18 col-md-12" style="padding: 0">
				<div id="alert_info" class="container-fluid div-flex col-lg-12 col-xs-18 col-md-12" style="position: absolute; min-height: 100%; background: rgba(255,255,255,0.7);z-index: 999999; display: none;">
					<div class="col-lg-5 col-xs-18 col-md-12">
						...
						<div class="pb-md-2 pb-5 col-lg-12 col-md-12 col-xs-18" style="min-width: 100%; background: white">
							<div class="col-lg-12 col-md-12 col-xs-18 text-center">
							...
							<div class="pb-md-5 pb-5 col-lg-12 col-md-12 col-xs-18 div-flex">
				...
				<div class="form-info col-lg-12 col-md-12 col-xs-18">
					<div class="col-lg-5 col-md-12 col-xs-18 mx-4">
						<div class="col-lg-12 col-md-12 col-xs-12">
						</div>
					</div>
					<div class="pt-5 pt-md-5 col-lg-6 col-md-12 col-xs-18">
						<div class="title-banner pt-xs-0 pt-md-5 pt-5  mt-5 mt-xs-5 mt-md-5 pl-5 pl-md-5 col-lg-12 col-md-12 col-xs-12">
							<p class=" pt-5 pt-md-5 pl-5 pl-md-5 col-lg-12 col-md-6 col-xs-18" style="color: white; font-size: 24px; padding: 0;font-weight: 700;font-family: Arial">ĐẶC QUYỀN DÀNH CHO HỘI VIÊN</p>
						</div>
					</div>
					<div class="clear"></div>
				</div>
				<div class="form-data col-lg-12 col-md-12 col-xs-18">
					<div class="col-lg-offset-1 col-lg-5 col-md-6 col-xs-18">
						<div class=" py-xs-0 py-md-0 py-5 col-lg-12 col-md-12 col-xs-18"></div>
						<div class="data-left col-lg-12 col-md-12 col-xs-18 pull-right pr-2 pr-xs-0 pr-md-2">
							<h1 class="text-right pr-4 pr-xs-0 pr-md-0 col-xs-18 col-md-12" style="margin: 0; font-weight: bold; font-family:  Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif;color: white" >AN TÂM MUA SẮM</h1>
							<h3 class="col-xs-18 col-md-12 text-right pr-4 pr-xs-0 pr-md-0" style="margin: 0; font-weight: bold;font-family:  Calibri,Candara,Segoe,Segoe UI,Optima,Arial,sans-serif;color: white">THOẢI MÁI LỰA CHỌN</h3>
						</div>
						<div class="py-xs-0 py-md-0 py-3 col-lg-12 col-md-12 col-xs-18"></div>
						<div class="data-left-rate-xs col-lg-12 col-md-12 col-xs-18">
						...
						<div class="data-left-text-xs col-lg-12 col-md-12 col-xs-18">
					...
					<div class="form-search-lg col-lg-6  col-md-6 col-xs-18" style="padding: 0">
						<div class="col-lg-11 col-md-11 col-xs-12" style="padding: 0">
							<form style="padding: 0; display: block; background: rgba(198,197,214,0.85)" action="" id="register_form" class="form-group my-3 col-lg-8 col-md-8 col-xs-12">
								{{csrf_field()}}
								<div class="col-lg-12 col-md-12 col-xs-18" style="background: rgb(0,83,167);display: flex;align-items: center; justify-content: center;">
								...
								<div class=" col-lg-12 col-md-12 div-flex col-xs-18 form-group">
							...
							<form style="padding: 0; display: none;background: rgba(198,197,214,0.85)" action="/orders/show" id="data_form" method="post" class="form-group my-3 col-lg-8 col-md-8 col-xs-12">
								...
								<div class="py-0 col-lg-12 col-md-12 col-xs-18 form-group"></div>
								<div class=" col-lg-12 col-md-12 col-xs-18 form-group">
								...
								<div id="next_register" class=" col-lg-12 col-md-12 div-flex col-xs-18 form-group">
									<div class="col-lg-6 col-xs-9 col-md-6">
										<input class="col-lg-12 col-md-12 col-xs-18 btn btn-primary" name="btn_orders" type="submit" value="Đăng kí mua hàng">
									</div>
									<div class="col-lg-6 col-xs-9 col-md-6">
										<input class="col-lg-12 col-xs-18 col-md-12 btn btn-primary" type="submit" name="btn_upload" id="upload" value="Tải phiếu đăng ký">
									</div>
								</div>
					...
					<div class="py-xs-0 py-md-0 py-4 col-lg-12 col-md-12 col-xs-18"></div>		
					<div class="clear"></div>
				</div>
			</div>
		</div>
		<div class="div-partner col-lg-12 col-md-12 col-xs-18" style="padding: 0">
			<div class="col-lg-12 col-md-12 col-xs-18 text-center" style="padding-top: 20px;">
				<p style="font-weight: bold; color: #4c4c4c; font-size: 25px;">ĐỐI TÁC CỦA CHÚNG TÔI</p>
			</div>
			<div class="mb-5 col-lg-12 col-md-12 col-xs-18 div-flex">
				<div class="border-partner-xs col-lg-1 col-md-1 col-xs-2" style="border: 4px solid #4c4c4c"></div>
			</div>
			<div class="col-lg-12 pb-5 col-md-12 col-xs-18 div-flex">
	...
	<div class="form-search-xs col-lg-12 col-md-12 col-xs-18 " style="display: none; padding: 0">
		<div id="alert_info_xs" class="container-fluid div-flex col-lg-12 col-xs-18 col-md-12" style="position: absolute; min-height: 100%; background: rgba(0,0,0,0.8);z-index: 999999; display: none;width: 100%;">
			<div class="col-lg-5 col-xs-18 col-md-12" style="padding: 0">
				<div class="col-lg-12 col-md-12 col-xs-18"  style="background: #170e66">
					<h1 class="text-center py-2" style="color: white;font-size: 5vw;margin: 0">THÔNG TIN HỘI VIÊN</h1>
				</div>
				<div class="pb-md-2 pb-5 col-lg-12 col-md-12 col-xs-18" style="min-width: 100%; background: white">
					<div class="py-2 col-lg-12 col-md-12 col-xs-18 text-center">
					...
					<div class="col-lg-12 col-md-12 col-xs-18 div-flex">
		...
		<div class=" col-md-12 col-xs-18" style="padding: 0">
			<div class="title-banner-xs col-lg-12 col-md-12 col-xs-18">
				<p class="text-vw-5	 col-lg-12 col-md-12 col-xs-18">ĐẶC QUYỀN DÀNH CHO HỘI VIÊN</p>
			</div>
			<div class="col-md-12 col-xs-18 div-flex" style="padding: 0;">
				<form id="register_form_xs" class="form-banner-xs col-md-11 col-xs-17" style="padding: 0;" action="">
					{{csrf_field()}}
					<div class="col-md-12 col-xs-18" style="background: rgb(0,83,167);">
						<p class="text-vw-5 py-xs-0 py-md-3" style="color: white; font-weight: 600;padding: 5px;">Kiểm tra sức mua của bạn</p>	
					</div>
					<div class="col-md-12 col-xs-18">
						<div class="col-md-12 col-xs-18 form-group">
						...
						<div class="col-md-12 col-xs-18 py-2">
							<div class="col-md-12 col-xs-18 py-2">
								<div class="col-xs-18 div-flex py-2">
			...
			<div class="col-md-12 col-xs-18 div-flex" style="padding: 0;">
				<form id="data_form_xs" class="form-banner-xs col-md-11 col-xs-17" style="padding: 0; display: none" action="/orders/show" method="post">
					...
					<div class="col-md-12 col-xs-18">
						...
						<div class="col-md-12 col-xs-18 py-2" style="padding: 0">
							<div class="col-md-12 col-xs-18 py-2" style="padding: 0">
								<div class="col-xs-18 div-flex py-2" style="padding: 0">
		...
		<div class="div-partner-xs col-lg-12 col-md-12 col-xs-18" style="padding: 0">
			<div class="div-partner-xs col-lg-12 col-md-12 col-xs-18 text-center">
			...
			<div class="partner-img">
				<div class="py-5 py-xs-0 py-md-5 col-lg-12 col-md-12 col-xs-18 div-flex">
					<div class="col-lg-3 col-md-12 col-xs-9 mr-5">
						<img style="width: 100%" src="../img/home_page/mediamart.png" alt="">
					</div>
					<div class="col-lg-3 ml-5 col-md-12 col-xs-9">
				...
				{{-- <p class="col-xs-18 col-md-12" style="text-align: right;"><b>+51 trung tâm</b></p> --}}
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
		</div>
...
<section class="info-content container-fluid" style="padding: 0 ;border-bottom: 5px solid white">
	<div class="py-5 py-xs-0 py-md-5 col-lg-12 col-xs-18 col-md-12 div-flex display-none" style="background: #464646;padding: 0">
		...
		<div class="col-lg-6 col-md-12 col-xs-18">
			<h1 class="text-center" style="color: white;font-size: 60px;">50+</h1>
			<p class="text-center" style="color: white">Siêu thị bán lẻ áp dụng</p>
		</div>
	</div>
</section>
<section class="step-buy-product container-fluid" style="display: none;padding: 0; margin: 0; border-bottom: 10px solid rgba(127,127,127,0.1)">
	<div class="col-lg-12 col-xs-18 col-md-12" style="background: url('../img/home_page/contant.png') no-repeat;background-size: 100%; padding: 0;">
		<div class="col-lg-12 col-md-12 col-xs-18" style="background: rgba(127,127,127,0.5); padding: 0">
			<div class="py-xs-0 py-md-4 py-4 col-lg-12 col-xs-18 col-md-12" style="background: rgba(41,37,100,0.6)">
				<div class="col-lg-12 col-xs-18 col-md-12 text-center" style="text-align: center;">
					<h1 class="text-center" style="color: white;font-weight: bold">CÁC BƯỚC ĐỂ MUA HÀNG</h1>
				</div>
				<div class="pb-md-5 pb-5 div-flex col-lg-12 col-md-12 col-xs-18">
					<div class="col-lg-1" style="border: 3px solid white"></div>
				</div>
			</div>
			<div class="pt-xs-0 pt-md-5 pt-5 col-lg-12 col-md-12 col-xs-18 div-flex">
				<div class="col-lg-8 col-xs-8 col-md-12">
					<div class="col-lg-12 col-xs-18 col-md-12 div-flex">
					...
					<div class="col-lg-12 col-xs-18 col-md-12 div-flex">
						<div class="col-lg-12 col-md-12 col-xs-18" style="border: 2px solid white;position: absolute;"></div>
					...
					<div  class="py-xs-0 py-md-4 py-4 col-lg-12 col-xs-18 col-md-12 div-flex" style="z-index: 999999">
						<div id="b1">
							<div class="mt-2 col-lg-12 arrow_box col-md-12 col-xs-18 div-flex">
								<span class=" col-lg-5 font-next-step">
									Kiểm tra sức mua đã được cấp.
								</span>
								<span class=" col-lg-1 font-next-step">
									<img src="../img/home_page/arrow.png" alt="">
								</span>
								<span class=" col-lg-5 font-next-step">
									Hoặc đăng ký sức mua bằng cách chọn công ty và điền thông tin của bạn. Sức mua của bạn sẽ được cập nhật trong vòng 15 phút.
								</span>
							</div>
						</div>
						<div id="b2">
						</style>
						<div class="col-lg-12 arrow_box col-md-12 col-xs-18">
							<span class="col-lg-5 font-next-step">
					...
					<div id="b3" class="col-lg-12 col-md-12 col-xs-18" style="padding: 0;">
						<div class="py-5 py-xs-0 py-md-5 col-lg-12 arrow_box col-md-12 col-xs-18">
							<span class="col-lg-5 font-next-step">
								Mang theo chứng minh thư đến siêu thị 
							</span>
							<span class="col-lg-1 font-next-step mr-5">
								<img src="../img/home_page/arrow.png" alt="">
							</span>
							<span class="ml-5 col-lg-5 font-next-step">
								Ký hợp đồng, trả trước một phần và nhận hàng. 
							</span>
						</div>
					</div>
					<div id="b4" class="col-lg-12 col-md-12 col-xs-18" style="padding: 0;">
						<div class="py-5 py-xs-0 py-md-5 col-lg-12 arrow_box col-md-12 col-xs-18 div-flex">
							<span class="text-center col-lg-12 font-next-step">
		...
		<div class="py-5 py-xs-0 py-md-5 my-5 col-lg-12 col-xs-18 col-md-12"></div>
		<div class="clear"></div>
	</div>
</section>
<section class="step-buy-product-xs">
	<div class="title-next-step col-md-12 col-xs-18">
		<h1>Các bước để mua hàng</h1>
	</div>
	<div style="background: #cccccc">
		<div class="content-step col-md-12 col-xs-18 div-flex" style="background: #cccccc;"">
		...
		<div class="col-md-12 col-xs-18" style="background: #cccccc;padding: 0">
			<div class="col-md-12 col-xs-18 div-flex">
...
<section class="conddtion-desktop py-2 container-fluid col-lg-12 col-md-12 col-xs-18">
	<div class="row condition col-lg-12 col-md-12 col-xs-18">
...
<section class="conddtion-xs container-fluid col-lg-12 col-md-12 col-xs-18" >
